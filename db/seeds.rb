...
Ingredient.create!([
  ...
  {name: "Salt", creator_id: 1, buyInWholeUnits: false},
  {name: "Pepper", creator_id: 1, buyInWholeUnits: false},
  {name: "Whole-wheat seaseme buns", creator_id: 1, buyInWholeUnits: true},
  {name: "Red Onion", creator_id: 1, buyInWholeUnits: true},
  {name: "Red Peppers", creator_id: 1, buyInWholeUnits: true},
  {name: "Chimichurri", creator_id: 1, buyInWholeUnits: false},
  {name: "Lemon", creator_id: 1, buyInWholeUnits: true},
  {name: "Olive Oil", creator_id: 1, buyInWholeUnits: false},
  {name: "Pizza Crust", creator_id: 1, buyInWholeUnits: true},
  {name: "Barbeque Sauce", creator_id: 1, buyInWholeUnits: false},
  {name: "Smoked Gouda", creator_id: 1, buyInWholeUnits: true},
  {name: "Jalapeno Pepper", creator_id: 1, buyInWholeUnits: true},
  {name: "Kidney Beans", creator_id: 1, buyInWholeUnits: false},
  {name: "Cumin", creator_id: 1, buyInWholeUnits: true},
  {name: "Lime", creator_id: 1, buyInWholeUnits: true},
  {name: "Salsa Verde", creator_id: 1, buyInWholeUnits: true},
  {name: "Pepper Jack Cheese", creator_id: 1, buyInWholeUnits: true},
  {name: "Cilantro", creator_id: 1, buyInWholeUnits: false},
  {name: "Tomato", creator_id: 1, buyInWholeUnits: true},
  {name: "Green Bell Pepper", creator_id: 1, buyInWholeUnits: true},
  {name: "English Cucumber", creator_id: 1, buyInWholeUnits: true},
  {name: "Tomato Juice", creator_id: 1, buyInWholeUnits: true},
  {name: "Red Wine Vinegar", creator_id: 1, buyInWholeUnits: true},
  {name: "Garlic", creator_id: 1, buyInWholeUnits: true}
])
Property.create!([
